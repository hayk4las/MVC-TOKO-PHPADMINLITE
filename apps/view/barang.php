    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title text-success font-weight-bold">Data Barang</h3>
        ...
        <!-- Bagian Konten Data Barang -->
        <div class="card-body">
          <div class="container mt-3">
            <a href="index.php?page=tambah_barang" class="btn btn-success btn-sm font-weight-bold">Tambahkan Barang</a>
